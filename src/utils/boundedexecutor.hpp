...
//
// Small fixed-worker executor.  The queue is intentionally unbounded: callers
// may submit any number of manifests, while only `workerCount` tasks execute at
// once.  This avoids one-OS-thread-per-manifest without imposing a content cap.
